            ...
            <div class="row">
                ...
                <div class="col-lg-6 bg-white">
                    <div class="form d-flex align-items-center">
                        <div class="content">
                            <form id="register-form" method="POST" class="form-horizontal" action="{{ route('register') }}">
                                {{ csrf_field() }}

                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <div class="col-md-12">
                                        <input id="name" placeholder="Username" type="text" name="name" class="input-material form-control{{ $errors->has('name') ? ' is-invalid' : '' }}">
                                ...
                                <div class="form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }}">
                                    <div class="col-md-12">
                                        <input placeholder="Password confirmation" id="password_confirmation" type="password" name="password_confirmation" class="input-material form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}">
